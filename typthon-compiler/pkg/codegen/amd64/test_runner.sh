#!/bin/bash
# Comprehensive test runner for amd64 code generation

set -e

echo "======================================"
echo "  AMD64 Code Generation Test Suite"
echo "======================================"
echo ""
