#!/bin/bash
# Comprehensive test runner for RISC-V 64-bit code generation

set -e

echo "=========================================="
echo "  RISC-V Code Generation Test Suite"
echo "=========================================="
echo ""
...
run_test "TestImmediateHandling"
run_test "TestMultipleArguments"
...
run_test "TestValidatorZeroRegisterWrite"
run_test "TestValidatorDivisionByZero"
run_test "TestValidatorWithGeneratedCode"
run_test "TestValidatorComplexFunction"
run_test "TestValidatorRedundantMoves"
run_test "TestValidatorConditionalBranches"
run_test "TestValidatorJumpOperations"
run_test "TestValidatorFramePointerHandling"
run_test "TestValidatorLargeImmediates"
run_test "TestValidatorImmediateOutOfRange"
run_test "TestValidatorMultipleErrors"
run_test "TestValidatorAtomicInstructions"
run_test "TestValidatorPseudoInstructions"

echo ""
echo "3. Quick Tests"
echo "--------------"

run_test "TestQuickValidate"
run_test "TestValidateAndReport"
